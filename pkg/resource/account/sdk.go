...
func (rm *resourceManager) sdkCreate(
	...
	var resp *svcsdk.CreateAccountOutput
	_ = resp
	resp, err = rm.sdkapi.CreateAccount(ctx, input)
	rm.metrics.RecordAPICall("CREATE", "CreateAccount", err)
	if err != nil {
		return nil, err
	}
	// Merge in the information we read from the API call above to the copy of
	...
	if resp.CreateAccountStatus.AccountName != nil {
		ko.Spec.Name = resp.CreateAccountStatus.AccountName
	} else {
		ko.Spec.Name = nil
	}
	...
	if resp.CreateAccountStatus.Id != nil {
		ko.Status.CreateAccountRequestID = resp.CreateAccountStatus.Id
	} else {
		ko.Status.CreateAccountRequestID = nil
	}
...
func (rm *resourceManager) newCreateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.CreateAccountInput, error) {
	res := &svcsdk.CreateAccountInput{}

	if r.ko.Spec.Name != nil {
		res.AccountName = r.ko.Spec.Name
	}
	if r.ko.Spec.Email != nil {
		res.Email = r.ko.Spec.Email
	}
	if r.ko.Spec.IAMUserAccessToBilling != nil {
		res.IamUserAccessToBilling = svcsdktypes.IAMUserAccessToBilling(*r.ko.Spec.IAMUserAccessToBilling)
	}
...
func (rm *resourceManager) sdkUpdate(
	...
	return rm.customUpdateAccount(ctx, desired, latest, delta)
}
...
func (rm *resourceManager) sdkDelete(
	...
	var resp *svcsdk.CloseAccountOutput
	_ = resp
	resp, err = rm.sdkapi.CloseAccount(ctx, input)
	rm.metrics.RecordAPICall("DELETE", "CloseAccount", err)
	return nil, err
}
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.CloseAccountInput, error) {
	res := &svcsdk.CloseAccountInput{}
