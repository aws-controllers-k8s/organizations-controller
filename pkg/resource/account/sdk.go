...
func (rm *resourceManager) sdkFind(
	...
	resp, err = rm.sdkapi.DescribeAccountWithContext(ctx, input)
...
func (rm *resourceManager) newDescribeRequestPayload(
	...
	if r.ko.Status.AccountID != nil {
		res.SetAccountId(*r.ko.Status.AccountID)
	}
...
func (rm *resourceManager) sdkCreate(
	...
	_ = resp
	resp, err = rm.sdkapi.CreateAccountWithContext(ctx, input)
	...
	if resp.CreateAccountStatus.AccountName != nil {
		ko.Spec.AccountName = resp.CreateAccountStatus.AccountName
	} else {
		ko.Spec.AccountName = nil
	}
	...
	if resp.CreateAccountStatus.FailureReason != nil {
		ko.Status.FailureReason = resp.CreateAccountStatus.FailureReason
	} else {
	...
	if resp.CreateAccountStatus.Id != nil {
		ko.Status.ID = resp.CreateAccountStatus.Id
	} else {
		ko.Status.ID = nil
	}
	...
	if resp.CreateAccountStatus.State != nil {
		ko.Status.State = resp.CreateAccountStatus.State
	} else {
		ko.Status.State = nil
	}
...
func (rm *resourceManager) newCreateRequestPayload(
	...
	if r.ko.Spec.AccountName != nil {
		res.SetAccountName(*r.ko.Spec.AccountName)
	}
	if r.ko.Spec.Email != nil {
		res.SetEmail(*r.ko.Spec.Email)
	}
	if r.ko.Spec.IAMUserAccessToBilling != nil {
		res.SetIamUserAccessToBilling(*r.ko.Spec.IAMUserAccessToBilling)
	}
