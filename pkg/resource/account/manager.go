...
// +kubebuilder:rbac:groups=organizations.services.k8s.aws,resources=accounts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=organizations.services.k8s.aws,resources=accounts/status,verbs=get;update;patch
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	stateCandidates := []string{"ACTIVE", "SUSPENDED"}
