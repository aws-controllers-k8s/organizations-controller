...
const (
	FinalizerString = "finalizers.organizations.services.k8s.aws/Account"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("accounts")
