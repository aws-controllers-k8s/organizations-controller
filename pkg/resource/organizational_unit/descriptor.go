...
const (
	finalizerString = "finalizers.organizations.services.k8s.aws/OrganizationalUnit"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("organizationalunits")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.OrganizationalUnit{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.OrganizationalUnit),
	}
}
