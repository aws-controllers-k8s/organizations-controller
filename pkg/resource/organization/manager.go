...
// +kubebuilder:rbac:groups=organizations.services.k8s.aws,resources=organizations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=organizations.services.k8s.aws,resources=organizations/status,verbs=get;update;patch
...
type resourceManager struct {
	...
	sdkapi svcsdkapi.OrganizationsAPI
}
