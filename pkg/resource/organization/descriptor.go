...
const (
	finalizerString = "finalizers.organizations.services.k8s.aws/Organization"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("organizations")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.Organization{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.Organization),
	}
}
